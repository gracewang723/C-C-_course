...
2.Input natural number N. Use loop structure to output all prime numbers which is less than or equal to N. Then count the number of primes and finally output it.
