...
* **2018.10.09: The third class. You are supposed to watch the teaching video before class, in order to know the case structure in control statements which means that you need to learn IF-ELSE statement, nested use of IF statement and the usage of SWITCH statement.**
